...
from public.shipping_info si
   ...
   left join public.shipping_agreement sa on sa.agreementid = si.shipping_agremeent_id
   left join public.shipping_country_rates cr on cr.id = si.shipping_country_rate_id
